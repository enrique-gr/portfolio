...
const PROJECTS = {
  "mide": {
    ...
    category: "featured",
    logoUrl: "images/mide.png",
    role: "UAS Engineering Intern",
    dates: "Summer 2026",
    tags: ["UAS Design & Fabrication", "Flight Test", "Mechanical & Electrical Upgrades"],
    summary: "Embedded across several UAS research teams at MIDE, contributing to the full engineering lifecycle — from design and hands-on fabrication through ground testing and live flight operations on a variety of aircraft upgrade programs.",
    metric: "Focus: Design → Fabrication → Test → Flight",
    problem: "Develop, integrate, and validate mechanical and electrical upgrades across multiple UAS platforms through a complete design-to-flight engineering cycle.",
    contribution: "Contributing across teams on system design, hardware fabrication, instrumentation, ground testing, and flight test support for a range of UAS upgrade programs.",
    result: "Hands-on involvement at every phase of the engineering lifecycle — translating design intent into flight-validated hardware across concurrent research projects.",
    constraint: "Coordinating across multiple concurrent teams with distinct platforms and upgrade goals",
    tradeoff: "Breadth of cross-team lifecycle exposure vs depth on any single system",
    decision: "Prioritized full-lifecycle participation — staying involved from design through flight test — to build a complete picture of how UAS upgrades go from concept to airborne validation",
    outcome: "Flight-tested hardware upgrades across mechanical and electrical domains, supported by rigorous ground test and instrumentation workflows",
    proof: [
      "Design and fabrication of mechanical and electrical UAS upgrades",
      "Instrumentation setup and sensor data workflows for ground and flight test",
      "Live flight test support — pre-flight checks, telemetry monitoring, post-flight analysis"
    ],
